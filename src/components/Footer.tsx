      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            <div className="text-2xl font-bold text-gradient mb-2">Balaji S</div>
            <p className="text-muted-foreground dark:text-muted-foreground">Software Developer & Data Scientist</p>
          </div>
