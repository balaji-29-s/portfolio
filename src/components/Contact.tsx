...
export const Contact = () => {
  ...
  e.preventDefault();
  try {
    const response = await fetch("https://formspree.io/f/placeholder", { // <-- replace with your Formspree endpoint
      method: "POST",
      headers: {
  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      content: "bs8315@srmist.edu.in",
      href: "mailto:bs8315@srmist.edu.in"
    },
    {
      icon: <Phone className="w-6 h-6" />,
      title: "Location",
      content: "Vandallur, Chennai",
      href: "#"
    },
    {
      icon: <MapPin className="w-6 h-6" />,
      title: "Available for",
      content: "Internships & Projects",
      href: "#"
    }
  ];
