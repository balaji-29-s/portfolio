...
import internshipsRaw from "@/data/internships.json";
...
export const Experience = () => {
  ...
  const internships: Certification[] = parseCertifications(internshipsRaw);
  ...
  return (
    <section id="experience" className="py-20 px-6 dark:bg-background relative">
      ...
      <div className="max-w-6xl mx-auto pt-8">
        ...
        {/* Internships Section */}
        <div className="mb-16">
          <h3 className="text-3xl font-semibold mb-8 text-center dark:text-white">Internships & Experience</h3>
                ...
                <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4">
                      <h4 className="text-xl font-semibold text-primary dark:text-primary">
                        {internship.title}
                      </h4>
                    ...
                    <div className="mb-6">
                      <h5 className="font-semibold dark:text-white mb-3">Key Responsibilities & Achievements:</h5>
